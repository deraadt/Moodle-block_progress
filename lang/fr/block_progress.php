...
/**
 * Progress Bar block French language translation
 *
 * @package    contrib
 * @subpackage block_progress
 * @copyright  2010 Fabien Sartoretti
...
$string['hotpot'] = 'Pommes de terre chaudes';
...
<p>Certains cours ne se focalisent pas sur la complétion de tâches pour une date précise. Certains cours sont ouverts à l\auto-inscription, permettant ainsi aux étudiants de travailler à leur rythme.</p>
...
<p>La raison d\être de ce bloc est d\'encourager les étudiants à gérer de manière effective leur temps de travail. Chaque étudiant peut contrôler son avancement pour chaque activité et ressource que vous avez créées.</p>
...
<p>Lorsqu\'une activité peut avoir une échéance et que l\échéance est définie, vous avez le choix d\'utiliser l\'échéance définie dans le formulaire de l\'activité ou de définir une échéance différente à l\'aide du formulaire du bloc "Barre de progression".</p>
...
<p>Lorsqu\'une activité n\'est pas vérouillée, le changement de la date et de l\'heure dans le bloc "Barre de progression" n\'affectera pas l\échéance définie dans le formulaire de l\'activité.</p>
';
$string['what_expected_by_means'] = 'Que signifie "attendu"?';
$string['what_expected_by_means_help'] = '
<p>Le paramètre <em>Attendu le</em> définit la date et l\'heure auxquelles l\'activité en question doit être terminée (visualisé, soumis, posté, etc...).</p>
...
$string['overview'] = 'Aperçu des étudiant-e-s';
