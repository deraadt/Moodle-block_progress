...
http://docs.moodle.org/22/en/Installing_contributed_modules_or_plugins
...
7. Set the activities/resources you want shown in the block (choose "Yes")
8. Set the date and time when the activity/resource is expected to be completed/viewed by (some
